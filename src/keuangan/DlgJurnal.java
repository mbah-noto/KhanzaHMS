...
public class DlgJurnal extends javax.swing.JDialog {
    ...
    public DlgJurnal(java.awt.Frame parent, boolean modal) {
        ...
        Ktg.setDocument(new batasInput((byte)50).getKata(Ktg));
        ...
        Valid.autoNomer("jurnal","JR",6,NoJur);
    }
    ...
    private void initComponents() {
        ...
        TglJurnal.setDisplayFormat("yyyy-MM-dd");
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        }else if(tipe.getText().trim().equals("R")&&balance.getText().trim().equals("K")&&(!debet.getText().equals("0"))){
            JOptionPane.showMessageDialog(null,"Maaf, Rekening memiliki tipe 'R' dan balance 'K'.\nDebet harus bernilai 0 !!!");
            debet.setText("0");
            debet.requestFocus();
        }else if(tipe.getText().trim().equals("R")&&balance.getText().trim().equals("D")&&(!kredit.getText().equals("0"))){
...
*/
            ...
            if (reply == JOptionPane.YES_OPTION) {
                try {
                    koneksi.createStatement().execute(
                        "insert into jurnal values('"+NoJur.getText()+"','"+NoBukti.getText()+"','"+TglJurnal.getSelectedItem()+"','"+Jenis.getSelectedItem().toString().substring(0,1) +"','"+Ktg.getText()+"')");
                    ResultSet rs=koneksi.createStatement().executeQuery(
                        "select kd_rek, nm_rek, debet, kredit from tampjurnal");
                    while(rs.next()){
                        koneksi.createStatement().execute(
                            "insert into detailjurnal values('"+NoJur.getText()+"','"+rs.getString(1) +"','"+rs.getString(3) +"','"+rs.getString(4) +"')");
                    }
                    BtnBatalActionPerformed(evt);                
                } catch (SQLException ex) {
                    int konfirm = JOptionPane.showConfirmDialog(rootPane,"No.Jurnal sudah ada sebelumnya,\napa data mau ditambahkan ke jurnal di No.Jurnal tersebut..??","Konfirmasi",JOptionPane.YES_NO_OPTION);
    ...
    */
    ...
    public void setData(String nobukti){
        ...
        Ktg.setText("Perubahan piutang dagang");
    }
    
    public void isCek(){
        BtnSimpan.setEnabled(var.getjurnal());
        BtnHapus.setEnabled(var.getjurnal());
        BtnBatal.setEnabled(var.getjurnal());
        BtnTambah.setEnabled(var.getjurnal());      
        ppHapus.setEnabled(var.getjurnal());
        ppTambah.setEnabled(var.getjurnal());
    }
