...
public final class DlgLhtBiaya extends javax.swing.JDialog {
    ...
    public DlgLhtBiaya(java.awt.Frame parent, boolean modal) {
        ...
        try {
           pstampil=koneksi.prepareStatement(
                   "select billing.no,billing.nm_perawatan, if(billing.biaya<>0,billing.biaya,'') as satu, "+
                   "if(billing.jumlah<>0,billing.jumlah,'') as dua,"+
                   "if(billing.tambahan<>0,billing.tambahan,'') as tiga, "+
                   "if(billing.totalbiaya<>0,billing.totalbiaya,'') as empat,billing.pemisah "+
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Tagihan Pasien Yang Sudah Dibayar(Pembayaran Cash) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            String biaya,tambahan,total;
            for(i=0;i<row;i++){  
                    biaya="";
                    if(!tabMode.getValueAt(i,3).toString().isEmpty()){
                        biaya=Valid.SetAngka(Double.parseDouble(tabMode.getValueAt(i,3).toString()));
                    }
                    tambahan="";
                    if(!tabMode.getValueAt(i,5).toString().isEmpty()){
                        tambahan=Valid.SetAngka(Double.parseDouble(tabMode.getValueAt(i,5).toString()));
                    }
                    total="";
                    if(!tabMode.getValueAt(i,6).toString().isEmpty()){
    ...
    */
    ...
    public void tampil(){
        ...
        try{            
            ...
            pstampil.setString(2,Tgl1.getSelectedItem().toString());
            pstampil.setString(3,Tgl2.getSelectedItem().toString());
            rstampil=pstampil.executeQuery();
            tulis="";
            while(rstampil.next()){
                if(rstampil.getString("empat").equals("0")){
                    tulis=""; 
                }else{
                    tulis=rstampil.getString("empat");
                }
                
                tabMode.addRow(new Object[]{rstampil.getString("no"),
                                    rstampil.getString("nm_perawatan"),
                                    rstampil.getString("pemisah"),
                                    rstampil.getString("satu"),
                                    rstampil.getString("dua"),
                                    rstampil.getString("tiga"),tulis});
            }
            //rs.close();
            all=0;y=0;
            for(i=0;i<tabMode.getRowCount();i++){ 
                ...
                }else if(tabMode.getValueAt(i,6).toString().isEmpty()){
                    y=0;                
                }
                all=all+y;
            }
