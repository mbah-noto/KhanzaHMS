    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("rekening","'"+Kd.getText()+"','"+
                    ...
                    Balan.getSelectedItem().toString().substring(0,1)+"'","Kode Rekening");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    */
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            switch (tbKamar.getValueAt(row,2).toString()) {
                case "N":
                    Tipe.setSelectedIndex(0);
                    break;
                case "R":
            ...
            switch (tbKamar.getValueAt(row,3).toString()) {
                case "D":
                    Balan.setSelectedIndex(0);
                    break;
                case "K":
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getrekening());
        BtnBatal.setEnabled(var.getrekening());
        BtnEdit.setEnabled(var.getrekening());
        BtnHapus.setEnabled(var.getrekening());
        BtnPrint.setEnabled(var.getrekening());
        ppSimpan.setEnabled(var.getrekening());
        ppGanti.setEnabled(var.getrekening());        
        ppHapus.setEnabled(var.getrekening());
        ppCetak.setEnabled(var.getrekening());
    }
