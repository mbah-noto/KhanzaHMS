...
public final class DlgPindahGudang extends javax.swing.JDialog {
    ...
    public DlgPindahGudang(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"<html><font color='#646464' face='Tahoma'>Dari",
                      "<html><font color='#646464' face='Tahoma'>",
                      "<html><font color='#646464' face='Tahoma'>Ke",
                      "<html><font color='#646464' face='Tahoma'>",
                      "<html><font color='#646464' face='Tahoma'>Barang",
                      "<html><font color='#646464' face='Tahoma'>",
                      "<html><font color='#646464' face='Tahoma'>Jumlah Barang",
                      "<html><font color='#646464' face='Tahoma'>Tanggal Mutasi",
                      "<html><font color='#646464' face='Tahoma'>Keterangan"};
        ...
        kddari.setDocument(new batasInput((byte)5).getKata(kddari));
        kdke.setDocument(new batasInput((byte)5).getKata(kdke));
        ...
        bangsal.getTable().addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) { 
                if(pilihan==2){
                    kdke.setText(bangsal.getTextField().getText());
                    Sequel.cariIsi("select nm_bangsal from bangsal where kd_bangsal='"+kdke.getText()+"'", nmke);
                }else if(pilihan==1){
                    kddari.setText(bangsal.getTextField().getText());
        ...
        ppSimpan.setEnabled(var.getobat());       
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Mutasi Antar Gudang ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
        ...
        BtnCari6.setBounds(410, 10, 28, 23);
        ...
        BtnCari7.setBounds(410, 40, 28, 23);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2014-03-27" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2014-03-27" }));
        ...
        BtnCetak.setMnemonic('H');
        BtnCetak.setText("Cetak");
        BtnCetak.setToolTipText("Alt+H");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(nmdari.getText().trim().equals("")){
            Valid.textKosong(nmdari,"Asal bangsal");
        }else if(jumlah.getText().trim().equals("")||jumlah.getText().trim().equals("0")){
            Valid.textKosong(jumlah,"Jumlah Barang");
        }else if(Keterangan.getText().trim().equals("")){
            Valid.textKosong(Keterangan,"Keterangan");
        }else if(nmke.getText().trim().equals("")){
            Valid.textKosong(kdke,"Tujuan bangsal");
        }else{ 
            Sequel.menyimpan("mutasibarang","'"+kdbarang.getText()+"','"+jumlah.getText()+"','"+kddari.getText()+"',"+
                    "'"+kdke.getText()+"','"+Tanggal.getSelectedItem()+"','"+Keterangan.getText()+"'","Mutasi Antar bangsal"); 
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            ...
            Valid.pindah(evt,Tanggal,BtnAll);
        }
}//GEN-LAST:event_BtnSimpanKeyPressed

    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,kdbarang,"mutasibarang","kd_bangsaldari='"+kddari.getText()+
                        "' and kd_bangsalke='"+kdke.getText()+"' and tanggal='"+Tanggal.getSelectedItem()+"' and kode_brng");
        Sequel.menyimpan("gudangbarang","'"+kdbarang.getText()+"','"+kddari.getText()+"','-"+jumlah.getText()+"'", 
                            "stok=stok+"+jumlah.getText()+"","kode_brng='"+kdbarang.getText()+"' and kd_bangsal='"+kddari.getText()+"'");
        Sequel.menyimpan("gudangbarang","'"+kdbarang.getText()+"','"+kdke.getText()+"','"+jumlah.getText()+"'", 
                            "stok=stok-"+jumlah.getText()+"","kode_brng='"+kdbarang.getText()+"' and kd_bangsal='"+kdke.getText()+"'");
    ...
    private void BtnHapusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnHapusKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            ...
            Valid.pindah(evt, BtnSimpan, BtnAll);
        }
...
private void BtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCetakActionPerformed
       this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(nmdari.getText().trim().equals("")){
            Valid.textKosong(kddari,"bangsal Asal");
        }else if(nmke.getText().trim().equals("")){
            Valid.textKosong(kdke,"bangsal Tujuan");
        }else if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            BtnKeluar.requestFocus();
        }else {                           
            String tgl=" mutasibarang.tanggal between '"+DTPCari1.getSelectedItem()+"' and '"+DTPCari2.getSelectedItem()+"' ";
            ...
            Valid.MyReport("rptMutasiObat.jrxml","report","::[ Transaksi Mutasi Barang ]::", sql);
