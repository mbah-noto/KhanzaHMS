...
public final class DlgKonversi extends javax.swing.JDialog {
    ...
    private void kdsat1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_kdsat1ItemStateChanged
        Sequel.cariIsi("select satuan from kodesatuan where kode_sat='"+kdsat1.getSelectedItem()+"'", nmsat1);
    ...
    private void kdsat2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_kdsat2ItemStateChanged
       Sequel.cariIsi("select satuan from kodesatuan where kode_sat='"+kdsat2.getSelectedItem()+"'", nmsat2);
    ...
    */
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getkonversisatuan());
        BtnHapus.setEnabled(var.getkonversisatuan());
        BtnPrint.setEnabled(var.getkonversisatuan());
               
        ppHapus.setEnabled(var.getkonversisatuan());
        ppCetak.setEnabled(var.getkonversisatuan());
        ppSimpan.setEnabled(var.getkonversisatuan());
    }
