 ...
 * @author dosen
 */
public final class DlgInputRetur extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgInputRetur(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2014-05-03" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgInputRetur dialog = new DlgInputRetur(new javax.swing.JFrame(), true);
