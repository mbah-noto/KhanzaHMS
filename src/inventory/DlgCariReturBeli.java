...
public class DlgCariReturBeli extends javax.swing.JDialog {
    ...
    public DlgCariReturBeli(java.awt.Frame parent, boolean modal) {
        ...
        BtnPrint.setEnabled(var.getreturbeli());
    }
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Retur Beli ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
  ...
  if(Kd2.getText().trim().equals("")){
     ...
     try {
         PreparedStatement pscariretur=koneksi.prepareStatement(
                 "select no_retur_beli, kd_bangsal from returbeli where no_retur_beli='"+Kd2.getText()+"'");
         ...
         while(rscariretur.next()){
             ...
             Sequel.menyimpan("tampjurnal","'54000','RETUR PEMBELIAN','"+Sequel.cariIsi("select sum(total) from detreturbeli where no_retur_beli='"+rscariretur.getString("no_retur_beli")+"'")+"','0'","Rekening");    
             Sequel.menyimpan("tampjurnal","'11120','KAS DI TANGAN','0','"+Sequel.cariIsi("select sum(total) from detreturbeli where no_retur_beli='"+rscariretur.getString("no_retur_beli")+"'")+"'","Rekening"); 
         ...
         Sequel.queryu("delete from returbeli where no_retur_beli='"+Kd2.getText()+"'");
         tampil();
...
private void tbDokterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDokterMouseClicked
    ...
    */
    ...
    public void tampil() {
        String tanggal=" returbeli.tgl_retur between '"+TglRetur1.getSelectedItem()+"' and '"+TglRetur2.getSelectedItem()+"' ";
        ...
        try{
            ...
            while(rs.next()){
                ...
                ResultSet rs2=stat2.executeQuery("select detreturbeli.no_faktur,detreturbeli.kode_brng,databarang.nama_brng, "+
                        ...
                        "detreturbeli.total from detreturbeli inner join databarang inner join kodesatuan "+
                        " on detreturbeli.kode_brng=databarang.kode_brng "+
