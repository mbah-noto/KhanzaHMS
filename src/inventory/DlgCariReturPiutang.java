...
public class DlgCariReturPiutang extends javax.swing.JDialog {
    ...
    public DlgCariReturPiutang(java.awt.Frame parent, boolean modal) {
        ...
        BtnPrint.setEnabled(var.getreturpiutang());
    }
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Retur Piutang ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
  ...
  if(Kd2.getText().trim().equals("")){
     ...
     try {
         PreparedStatement pscariretur=koneksi.prepareStatement(
                 "select no_retur_piutang, kd_bangsal from returpiutang where no_retur_piutang='"+Kd2.getText()+"'");
         ...
         while(rscariretur.next()){
             ...
             Sequel.menyimpan("tampjurnal","'74000','RETUR PIUTANG','0','"+Sequel.cariIsi("select sum(subtotal) from detreturpiutang where no_retur_piutang='"+rscariretur.getString("no_retur_piutang")+"'")+"'","Rekening");    
             Sequel.menyimpan("tampjurnal","'11120','KAS DI TANGAN','"+Sequel.cariIsi("select sum(subtotal) from detreturpiutang where no_retur_piutang='"+rscariretur.getString("no_retur_piutang")+"'")+"','0'","Rekening"); 
         ...
         Sequel.queryu("delete from returpiutang where no_retur_piutang='"+Kd2.getText()+"'");
         tampil();
...
private void tbReturMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbReturMouseClicked
    ...
    */
    ...
    public void tampil() {
        String tanggal=" returpiutang.tgl_retur between '"+TglRetur1.getSelectedItem()+"' and '"+TglRetur2.getSelectedItem()+"' ";
