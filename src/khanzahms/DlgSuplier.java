...
public class DlgSuplier extends javax.swing.JDialog {
    ...
    public DlgSuplier(java.awt.Frame parent, boolean modal) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if(i==0){
                ...
                column.setPreferredWidth(screen.width-895);
            }
        }
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Supplier ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.textKosong(Kota,"Kota");
             ...
             Valid.editTable(tabMode,"datasuplier","kode_suplier",Kd2,"kode_suplier='"+Kd.getText()+
                            "',nama_suplier='"+Nm.getText()+
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptSuplier.jrxml","report","::[ Data Suplier ]::",sql);            
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("datasuplier","'"+Kd.getText()+"','"+
                    Nm.getText()+"','"+
                    Alamat.getText()+"','"+
                    Kota.getText()+"','"+
                    Telp.getText()+"'","Kode Supplier");
            tampil();
            emptTeks();
        }
    ...
    */
    ...
    private void getData() {
        if(tbDokter.getSelectedRow()!= -1){
            ...
            Kd2.setText(tabMode.getValueAt(tbDokter.getSelectedRow(),0).toString());
