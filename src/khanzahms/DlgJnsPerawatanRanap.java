...
public final class DlgJnsPerawatanRanap extends javax.swing.JDialog {
    ...
    public DlgJnsPerawatanRanap(java.awt.Frame parent, boolean modal) {
        ...
        bangsal.getTable().addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) { 
                    KdKamar.setText(bangsal.getTextField().getText());
        ...
        try {            
            ps=koneksi.prepareStatement(
                   ...
                   "and penjab.kd_pj=jns_perawatan_inap.kd_pj where "+
                    "jns_perawatan_inap.kd_jenis_prw like ? or "+
    ...
    private void initComponents() {
        ...
        jLabel11.setBounds(361, 132, 141, 23);
        ...
        jLabel13.setBounds(361, 102, 141, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("jns_perawatan_inap","'"+TKd.getText()+"','"+
                    TNm.getText()+"','"+
                    KdKtg.getText()+"','"+
                    BagianRs.getText()+"','"+
                    TTndDr.getText()+"','"+
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"jns_perawatan_inap","kd_jenis_prw");
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.mengedit("jns_perawatan_inap","kd_jenis_prw='"+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),0).toString()+"'",
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReport("rptJnsPrw.jrxml","report","::[ Data Jenis Perawatan ]::","select kd_jenis_prw,nm_perawatan,nm_kategori,"+
                               ...
                               "from jns_perawatan_inap,kategori_perawatan "+
                               "where jns_perawatan_inap.kd_kategori=kategori_perawatan.kd_kategori order by kd_jenis_prw");
                ...
                Valid.MyReport("rptJnsPrw.jrxml","report","::[ Data Jenis Perawatan ]::","select jns_perawatan_inap.kd_jenis_prw,jns_perawatan_inap.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   ...
                   "and bangsal.kd_bangsal=jns_perawatan_inap.kd_bangsal "+
                   "and penjab.kd_pj=jns_perawatan_inap.kd_pj where "+
                    "jns_perawatan_inap.kd_jenis_prw like '%"+TCari.getText().trim()+"%' or "+
                    " jns_perawatan_inap.nm_perawatan like '%"+TCari.getText().trim()+"%' or "+
                    " kategori_perawatan.nm_kategori like '%"+TCari.getText().trim()+"%' or "+
                    " penjab.png_jawab like '%"+TCari.getText().trim()+"%' or "+
                    " bangsal.nm_bangsal like '%"+TCari.getText().trim()+"%'  "+
                    "order by jns_perawatan_inap.kd_jenis_prw ");
            }
        }
    ...
    */
    ...
    private void getData() {
        if(tbJnsPerawatan.getSelectedRow()!= -1){
            ...
            Sequel.cariIsi("select kd_kategori from jns_perawatan_inap where kd_jenis_prw=?", KdKtg,tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),0).toString());
            ...
            Sequel.cariIsi("select kd_pj from jns_perawatan_inap where kd_jenis_prw=?", kdpnj,tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),0).toString());
            nmpnj.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),8).toString());
            Sequel.cariIsi("select kd_bangsal from jns_perawatan_inap where kd_jenis_prw=?", KdKamar,tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),0).toString());
            NmKamar.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),9).toString());
        }
    }
