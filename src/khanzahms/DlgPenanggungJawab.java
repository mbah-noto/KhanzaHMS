...
public final class DlgPenanggungJawab extends javax.swing.JDialog {
    ...
    public DlgPenanggungJawab(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Askes/Asuransi",
                      "Nama Penanggung/Askes/Asuransi"};
    ...
    private void initComponents() {
        ...
        label36.setText("Asuransi/Askes :");
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,Kd,"penjab","kd_pj");
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptSatuan.jrxml","report","::[ Data Satuan ]::","select kd_pj, png_jawab "+
    ...
    */
    ...
    public void tampil(String order) {
        ...
        if(TCari.getText().equals("")){
            ...
            sql="select kd_pj, png_jawab "+
                " from penjab where  kd_pj like '%"+TCari.getText().trim()+"%' or "+
                " png_jawab like '%"+TCari.getText().trim()+"%' "+order;
        } 
        prosesCari(sql);
    }
    ...
    public void isCek(){
        /*BtnSimpan.setEnabled(var.getasuransi());
        BtnHapus.setEnabled(var.getasuransi());
        BtnEdit.setEnabled(var.getasuransi());
        BtnPrint.setEnabled(var.getasuransi());
        
        ppSimpan.setEnabled(var.getasuransi());  
        ppGanti.setEnabled(var.getasuransi());        
        ppHapus.setEnabled(var.getasuransi());
        ppCetak.setEnabled(var.getasuransi());*/
    }
}
