...
public final class DlgJnsPerawatanLab extends javax.swing.JDialog {
    ...
    public DlgJnsPerawatanLab(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Periksa","Nama Pemeriksaan","Bagian RS","J.M. Laborat","Total Biaya Periksa","Cara Bayar"};
        ...
        try {            
            ps=koneksi.prepareStatement(
                    ...
                    " jns_perawatan_lab.bagian_rs like ? or jns_perawatan_lab.tarif_tindakan_petugas like ? or "+
    ...
    private void initComponents() {
        ...
        ppTemplate.setBackground(new java.awt.Color(242, 242, 242));
        ppTemplate.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppTemplate.setForeground(new java.awt.Color(102, 51, 0));
        ppTemplate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/file-edit-16x16.png"))); // NOI18N
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Tarif Pemeriksaan Lab ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
        ...
        BagianRs.setBounds(107, 40, 180, 23);

        jLabel9.setText("Bagian RS : Rp.");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(-10, 40, 115, 23);

        jLabel11.setText("Total Biaya Pemeriksaan : Rp. ");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(300, 72, 153, 23);
        ...
        TJmlPr.setBounds(453, 72, 263, 23);

        jLabel13.setText("J.M. Laborat : Rp.");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(-10, 70, 115, 23);
        ...
        TTndPr.setBounds(107, 70, 180, 23);

        jLabel18.setText("Cara Bayar :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(300, 42, 130, 23);
        ...
        FormInput.add(kdpnj);
        kdpnj.setBounds(433, 42, 60, 23);

        nmpnj.setEditable(false);
        nmpnj.setName("nmpnj"); // NOI18N
        FormInput.add(nmpnj);
        nmpnj.setBounds(495, 42, 192, 23);
        ...
        BtnSeek5.setBounds(688, 42, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TTndPr,"Total Biaya Pemeriksaan");
        }else{
            Sequel.menyimpan("jns_perawatan_lab","'"+TKd.getText()+"','"+
                    TNm.getText()+"','"+
                    BagianRs.getText()+"','"+
                    TTndPr.getText()+"','"+
                    TJmlPr.getText()+"','"+
                    kdpnj.getText()+"'","Kode Periksa");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"jns_perawatan_lab","kd_jenis_prw");
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.mengedit("jns_perawatan_lab","kd_jenis_prw='"+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),0).toString()+"'",
                    "kd_jenis_prw='"+TKd.getText()+
                    "',nm_perawatan='"+TNm.getText()+
                    "',bagian_rs='"+BagianRs.getText()+
                    "',tarif_tindakan_petugas='"+TTndPr.getText()+
                    "',total_byr='"+TJmlPr.getText()+
                    "',kd_pj='"+kdpnj.getText()+"'");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            BtnBatal.requestFocus();
                ...
                Valid.MyReport("rptTarifLab.jrxml","report","::[ Data Tarif Laboratorium ]::","select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,jns_perawatan_lab.bagian_rs,"+
                    "jns_perawatan_lab.tarif_tindakan_petugas,jns_perawatan_lab.total_byr,penjab.png_jawab "+
                    "from jns_perawatan_lab inner join penjab on penjab.kd_pj=jns_perawatan_lab.kd_pj where "+
                    " jns_perawatan_lab.kd_jenis_prw like '%"+TCari.getText().trim()+"%' or  jns_perawatan_lab.nm_perawatan like '%"+TCari.getText().trim()+"%' or "+
                    " jns_perawatan_lab.bagian_rs like '%"+TCari.getText().trim()+"%' or jns_perawatan_lab.tarif_tindakan_petugas like '%"+TCari.getText().trim()+"%' or "+
                    " penjab.png_jawab like '%"+TCari.getText().trim()+"%' or jns_perawatan_lab.total_byr like '%"+TCari.getText().trim()+"%'  "+
                    "order by jns_perawatan_lab.kd_jenis_prw");   
        }
...
private void BtnSeek5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek5ActionPerformed
    ...
    private void ppTemplateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppTemplateActionPerformed
        template.KdPeriksa.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),0).toString());
        template.NmPeriksa.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),1).toString());
    ...
    */
    ...
    private void getData() {
        if(tbJnsPerawatan.getSelectedRow()!= -1){
            ...
            BagianRs.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),2).toString());
            TTndPr.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),3).toString());
            TJmlPr.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),4).toString());
            Sequel.cariIsi("select kd_pj from jns_perawatan_lab where kd_jenis_prw=?", kdpnj,tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),0).toString());
            nmpnj.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),5).toString());
        }
    }
