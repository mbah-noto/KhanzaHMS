...
public final class DlgSetOtoRalan extends javax.swing.JDialog {
    ...
    public DlgSetOtoRalan(java.awt.Frame parent, boolean modal) {
        ...
        kdtindakan.setDocument(new batasInput((byte)8).getKata(kdtindakan));
        kddokter.setDocument(new batasInput((byte)8).getKata(kddokter));
        TCari.setDocument(new batasInput((byte)100).getKata(TCari));

        
        datatindakan.getTable().addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                kdtindakan.setText(datatindakan.getTextField().getText());      
                Sequel.cariIsi("select nm_perawatan from jns_perawatan where kd_jenis_prw='"+kdtindakan.getText()+"'", nmtindakan);
            }
        ...
        datadokter.getTable().addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                kddokter.setText(datadokter.getTextField().getText()); 
    ...
    private DlgCariDokter datadokter=new DlgCariDokter(null,false);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(nmdokter.getText().trim().equals("")){
            ...
            Sequel.menyimpan("set_otomatis_tindakan_ralan","'"+kddokter.getText()+"','"+kdtindakan.getText()+"'","Kode Kamar");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.hapusTable(tabMode,kddokter,"set_otomatis_tindakan_ralan","kd_jenis_prw='"+kdtindakan.getText()+"' and kd_dokter");
            tampil();
            emptTeks();
        }
    ...
    private void BtnSeekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekActionPerformed
        datadokter.tampil(" order by nm_dokter");
        datadokter.isCek();
        datadokter.emptTeks();
        datadokter.setSize(internalFrame1.getWidth()-50,internalFrame1.getHeight()-50);
        datadokter.setLocationRelativeTo(internalFrame1);
...
private void kdtindakanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdtindakanKeyPressed
    ...
    */
    ...
    public void tampil() {
        String sql="select set_otomatis_tindakan_ralan.kd_dokter,dokter.nm_dokter, set_otomatis_tindakan_ralan.kd_jenis_prw,jns_perawatan.nm_perawatan "+
                   "from set_otomatis_tindakan_ralan inner join dokter inner join jns_perawatan on  "+
                   "set_otomatis_tindakan_ralan.kd_dokter=dokter.kd_dokter and "+
                   "set_otomatis_tindakan_ralan.kd_jenis_prw=jns_perawatan.kd_jenis_prw "+
                   "where set_otomatis_tindakan_ralan.kd_dokter like '%"+TCari.getText().trim()+"%' or "+
