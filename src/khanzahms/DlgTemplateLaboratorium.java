...
public final class DlgTemplateLaboratorium extends javax.swing.JDialog {
    ...
    public DlgTemplateLaboratorium(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Pemeriksaan","Satuan","N.Rujukan L.D.","N.Rujukan L.A.","N.Rujukan P.D.","N.Rujukan P.A.","Bagian RS","J.M.  Laborat","Biaya Item",""};
        tabMode=new DefaultTableModel(null,row){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return true;}
        };
        ...
        try {
            ps=koneksi.prepareStatement("select id_template, Pemeriksaan, satuan, nilai_rujukan_ld, nilai_rujukan_la, nilai_rujukan_pd,"+
                    "nilai_rujukan_pa,bagian_rs,bagian_laborat,biaya_item from template_laboratorium where kd_jenis_prw=? order by id_template");
             ...
             if(row>-1){
                 for(int i=0;i<row;i++){  
                     ...
                     if(tbKamar.getValueAt(i,9).toString().equals("")){
                         Sequel.menyimpan("template_laboratorium","'"+KdPeriksa.getText()+"','0','"+tbKamar.getValueAt(i,0).toString()+"','"+
                                 tbKamar.getValueAt(i,1).toString()+"','"+tbKamar.getValueAt(i,2).toString()+"','"+tbKamar.getValueAt(i,3).toString()+"','"+
                                 tbKamar.getValueAt(i,4).toString()+"','"+tbKamar.getValueAt(i,5).toString()+"','"+tbKamar.getValueAt(i,6).toString()+"','"+
                                 tbKamar.getValueAt(i,7).toString()+"','"+tbKamar.getValueAt(i,8).toString()+"'","Id Hasil Periksa");
                     }else if(!tbKamar.getValueAt(i,9).toString().equals("")){
                         Sequel.mengedit("template_laboratorium","id_template='"+tbKamar.getValueAt(i,9).toString()+"'","Pemeriksaan='"+tbKamar.getValueAt(i,0).toString()+"',satuan='"+
                                         tbKamar.getValueAt(i,1).toString()+"',nilai_rujukan_ld='"+tbKamar.getValueAt(i,2).toString()+"',nilai_rujukan_la='"+
                                         tbKamar.getValueAt(i,3).toString()+"',nilai_rujukan_pd='"+tbKamar.getValueAt(i,4).toString()+"',nilai_rujukan_pa='"+tbKamar.getValueAt(i,5).toString()+"',bagian_rs='"+
                                         tbKamar.getValueAt(i,6).toString()+"',bagian_laborat='"+tbKamar.getValueAt(i,7).toString()+"',biaya_item='"+tbKamar.getValueAt(i,8).toString()+"'");   
                     }
                 }
                 tampil();
             }             
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
   try{
       Sequel.meghapus("template_laboratorium","id_template",tbKamar.getValueAt(tbKamar.getSelectedRow(),9).toString());
    ...
    */
    ...
    private void getData() {
        ...
        if(row!= -1){
            if((!tbKamar.getValueAt(row,6).toString().equals(""))&&(!tbKamar.getValueAt(row,6).toString().equals(""))){
               tbKamar.setValueAt(Valid.SetAngka2(Valid.SetAngka(tbKamar.getValueAt(row,6).toString())+Valid.SetAngka(tbKamar.getValueAt(row,7).toString())), row,8); 
            }
        }
    } 
