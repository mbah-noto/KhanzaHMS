...
public final class DlgPoli extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        label32.setText("Biaya Registrasi :");
        label32.setName("label32"); // NOI18N
        label32.setPreferredSize(new java.awt.Dimension(35, 23));
        panelisi4.add(label32);
        label32.setBounds(215, 12, 168, 23);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,Kd,"poliklinik","kd_poli");
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"poliklinik","kd_poli",Kd2,"registrasi='"+By.getText()+
                    "',nm_poli='"+Nm.getText()+"',kd_poli='"+Kd.getText()+"'");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPoli.jrxml","report","::[ Data Unit ]::","select kd_poli, nm_poli, registrasi "+
                " from poliklinik where  kd_poli like '%"+TCari.getText().trim()+"%' or "+
                " nm_poli like '%"+TCari.getText().trim()+"%' or "+
                " registrasi like '%"+TCari.getText().trim()+"%' order by kd_poli");
        }
    ...
    */
    ...
    public void tampil(String order) {
        ...
        if(TCari.getText().equals("")){
            sql="select kd_poli, nm_poli, registrasi "+
                   "from poliklinik "+order;
        }else if(!TCari.getText().equals("")){
            sql="select kd_poli, nm_poli, registrasi "+
                " from poliklinik where  kd_poli like '%"+TCari.getText().trim()+"%' or "+
                " nm_poli like '%"+TCari.getText().trim()+"%' or "+
                " registrasi like '%"+TCari.getText().trim()+"%' "+order;
        } 
        prosesCari(sql);
    }
    ...
    private void getData() {
        if(tbKamar.getSelectedRow()!= -1){
            ...
            By.setText(tbKamar.getValueAt(tbKamar.getSelectedRow(),2).toString());
        }
    }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getpoli());
        BtnHapus.setEnabled(var.getpoli());
        BtnEdit.setEnabled(var.getpoli());
        BtnPrint.setEnabled(var.getpoli());
    }
}
