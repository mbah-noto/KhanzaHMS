...
public final class DlgRujuk extends javax.swing.JDialog {
    ...
    public DlgRujuk(java.awt.Frame parent, boolean modal) {
        ...
        dokter.getTable().addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Sequel.cariIsi("select nm_dokter from dokter where kd_dokter='"+dokter.getTextField().getText()+"'",TDokter);
            }
    ...
    private void initComponents() {
        ...
        MnResepObat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Drug-basket-32.png"))); // NOI18N
        ...
        MnSurat.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        MnSurat.setForeground(java.awt.Color.darkGray);
        MnSurat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/PatientFile.png"))); // NOI18N
        MnSurat.setText("Surat Rujuk Pasien");
        MnSurat.setName("MnSurat"); // NOI18N
        MnSurat.setPreferredSize(new java.awt.Dimension(250, 28));
        ...
        TPasien.setBounds(359, 42, 338, 23);

        DTPRujuk.setEditable(false);
        DTPRujuk.setForeground(new java.awt.Color(50, 70, 50));
        DTPRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2014-05-04" }));
        DTPRujuk.setDisplayFormat("yyyy-MM-dd");
        ...
        BtnSeek.setBounds(699, 42, 28, 23);
        ...
        BtnSeekDokter.setMnemonic('2');
        BtnSeekDokter.setToolTipText("Alt+2");
        ...
        BtnSeekDokter.setBounds(699, 102, 28, 23);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRj.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"rujuk","no_rujuk",TNoRj,"no_rawat='"+TNoRw.getText()+
                    ...
                    "',tgl_rujuk='"+DTPRujuk.getSelectedItem()+
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            String tgl=" rujuk.tgl_rujuk between '"+DTPCari1.getSelectedItem()+"' and '"+DTPCari2.getSelectedItem()+"' ";
...
private void MnSuratActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSuratActionPerformed
     this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(TNoRj.getText().trim().equals("")){
            ...
            Valid.panggilUrl("billing/LaporanRujuk.php?norujuk="+TNoRj.getText().replaceAll(" ","_")+"&rujukke="+TTmpRujuk.getText().replaceAll(" ","_")+
                             "&diagnosa="+TDiagnosa.getText().replaceAll(" ","_")+"&tanggal="+DTPRujuk.getSelectedItem()+"&dokter="+TDokter.getText().replaceAll(" ","_")+
                             "&norm="+TNoRM.getText().replaceAll(" ","_")+"&norw="+TNoRw.getText().replaceAll(" ","_"));                       
        }
        this.setCursor(Cursor.getDefaultCursor());
