...
public class DlgPasienMati extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakSuratMati.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/new_page.png"))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Sequel.menyimpan("pasien_mati","'"+DTPTgl.getSelectedItem()+"','"+
...
private void MnCetakSuratMatiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratMatiActionPerformed
    ...
    */
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getpasienmati());
        BtnHapus.setEnabled(var.getpasienmati());
        BtnPrint.setEnabled(var.getpasienmati());
    }
