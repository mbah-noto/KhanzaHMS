...
public final class DlgJenis extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppOrderKode.setText("Kode Satuan");
        ...
        ppOrderNama.setText("Nama Satuan");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Jenis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,Kd,"jenis","kdjns");
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"jenis","kdjns",Kd2,"nama='"+Nm.getText()+
                    "',keterangan='"+Keterangan.getText()+"',kdjns='"+Kd.getText()+"'");
    ...
    */
    ...
    public void tampil(String order) {
        ...
        if(TCari.getText().equals("")){
            sql="select kdjns, nama, keterangan "+
                   "from jenis "+order;
        }else if(!TCari.getText().equals("")){
            sql="select kdjns, nama, keterangan "+
                " from jenis where  kdjns like '%"+TCari.getText().trim()+"%' or "+
                " nama like '%"+TCari.getText().trim()+"%' or "+
                " keterangan like '%"+TCari.getText().trim()+"%' "+order;
        } 
        prosesCari(sql);
    }
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            Keterangan.setText(tbKamar.getValueAt(row,2).toString());
        }
    }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getjenis());
        BtnHapus.setEnabled(var.getjenis());
        BtnEdit.setEnabled(var.getjenis());
        BtnPrint.setEnabled(var.getjenis());
        
        ppGanti.setEnabled(var.getjenis());        
        ppHapus.setEnabled(var.getjenis());
        ppCetak.setEnabled(var.getjenis());
        ppSimpan.setEnabled(var.getjenis());
    }
}
