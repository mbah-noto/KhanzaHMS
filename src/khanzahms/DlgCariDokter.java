    ...
    */
    ...
    public void tampil(String order) {
        ...
        if(TCari.getText().equals("")){
            sql="select kd_dokter,nm_dokter,jk,tmp_lahir, "+
                   "tgl_lahir,gol_drh,agama,almt_tgl,no_telp, "+
                   "stts_nikah,nm_sps,alumni,no_ijn_praktek "+
                   "from dokter,spesialis "+
                   "where dokter.kd_sps=spesialis.kd_sps "+order;
        }else if(!TCari.getText().equals("")){
            String say=" dokter.kd_sps=spesialis.kd_sps ";        
            sql="select kd_dokter,nm_dokter,jk,tmp_lahir, "+
                "tgl_lahir,gol_drh,agama,almt_tgl,no_telp, "+
                "stts_nikah,nm_sps,alumni,no_ijn_praktek "+
                "from dokter,spesialis "+
                "where "+
                say+"and kd_dokter like '%"+TCari.getText().trim()+"%' or "+
                say+"and nm_dokter like '%"+TCari.getText().trim()+"%' or "+
                say+"and jk like '%"+TCari.getText().trim()+"%' or "+
                say+"and tmp_lahir like '%"+TCari.getText().trim()+"%' or "+
                say+"and tgl_lahir like '%"+TCari.getText().trim()+"%' or "+
                say+"and gol_drh like '%"+TCari.getText().trim()+"%' or "+
                say+"and agama like '%"+TCari.getText().trim()+"%' or "+
                say+"and almt_tgl like '%"+TCari.getText().trim()+"%' or "+
                say+"and no_telp like '%"+TCari.getText().trim()+"%' or "+
                say+"and stts_nikah like '%"+TCari.getText().trim()+"%' or "+
                say+"and nm_sps like '%"+TCari.getText().trim()+"%' or "+
                say+"and alumni like '%"+TCari.getText().trim()+"%' or "+
                say+"and no_ijn_praktek like '%"+TCari.getText().trim()+"%' "+order;
        } 
        prosesCari(sql);
    }
