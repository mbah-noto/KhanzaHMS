...
public final class DlgBangsal extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("bangsal","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode Kamar");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"bangsal","kd_bangsal");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.mengedit("bangsal","kd_bangsal='"+tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 0).toString() +"'","nm_bangsal='"+TNm.getText()+"',kd_bangsal='"+TKd.getText()+"'");
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        prosesCari("select * from bangsal where kd_bangsal like '%"+TCari.getText().trim()+"%' "+
                "or nm_bangsal like '%"+TCari.getText().trim()+"%' order by kd_bangsal");
    ...
    */
    ...
    public void tampil() {
        String sql="select * from bangsal order by kd_bangsal";
        prosesCari(sql);
    }
