...
public class DlgCariTagihanOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnHapusObatOperasi.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        MnHapusObatOperasi.setForeground(java.awt.Color.darkGray);
        MnHapusObatOperasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/PatientFile.png"))); // NOI18N
        ...
        MnHapusTagihanOperasi.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        MnHapusTagihanOperasi.setForeground(java.awt.Color.darkGray);
        MnHapusTagihanOperasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/PatientFile.png"))); // NOI18N
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Tagihan Operasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
        ...
        if(tabMode.getRowCount()==0){
            ...
            for(int i=0;i<row;i++){  
                Sequel.menyimpan("temporary","'0','"+
                                ...
                                tabMode.getValueAt(i,23).toString()+"','','','','','','','','','',''","Transaksi operasi"); 
            }
...
private void MnHapusObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusObatOperasiActionPerformed
  ...
  tampil();
    ...
    */
    ...
    public void tampil() {
        String tanggal="  operasi.tgl_operasi between '"+Tgl1.getSelectedItem()+"' and '"+Tgl2.getSelectedItem()+"' ";
        String mem="";      
        if(!kdmem.getText().equals("")){
            mem=" and pasien.no_rkm_medis='"+kdmem.getText()+"' ";
        }
        String sql="select operasi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, operasi.kd_penyakit,penyakit.nm_penyakit ,operasi.jenis_anasthesi,"+
                   "operasi.tgl_operasi from operasi inner join reg_periksa inner join pasien inner join penyakit  "+
                    " on operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    " and operasi.kd_penyakit=penyakit.kd_penyakit "+
                    ...
                    tanggal+mem+" and operasi.kd_penyakit like '%"+TCari.getText()+"%' or "+
                    tanggal+mem+" and penyakit.nm_penyakit  like '%"+TCari.getText()+"%' or "+
        ...
        try{
            ...
            while(rs.next()){
                ...
                ResultSet rs2=koneksi.createStatement().executeQuery(
                        ...
                        "operasi.asisten_operator2, operasi.asisten_operator3, operasi.dokter_anak, operasi.perawaat_resusitas, "+
                        "operasi.dokter_anestesi, operasi.asisten_anestesi, operasi.bidan, operasi.perawat_luar, "+
                        ...
                        "operasi.biayasewaok,operasi.biayasewavk,operasi.bagian_rs,operasi.omloop,(operasi.biayaoperator1+operasi.biayaoperator2+operasi.biayaoperator3+"+
                        "operasi.biayaasisten_operator1+operasi.biayaasisten_operator2+operasi.biayaasisten_operator3+"+
                        "operasi.biayadokter_anak+operasi.biayaperawaat_resusitas+operasi.biayadokter_anestesi+"+
                        "operasi.biayaasisten_anestesi+operasi.biayabidan+operasi.biayaperawat_luar+operasi.biayaalat+"+
                        "operasi.biayasewaok+operasi.biayasewavk+operasi.bagian_rs+operasi.omloop) as total from operasi inner join paket_operasi "+
                        "on operasi.kode_paket=paket_operasi.kode_paket where operasi.no_rawat='"+rs.getString("no_rawat")+"' and operasi.tgl_operasi='"+rs.getString("tgl_operasi")+"'");
                no=1;
                while(rs2.next()){
                    ...
                    Object[] data3={"","","","","","",Valid.SetAngka(rs2.getDouble("biayaoperator1")),
                               ...
                               Valid.SetAngka(rs2.getDouble("biayasewavk")),
                               Valid.SetAngka(rs2.getDouble("bagian_rs")),
                               Valid.SetAngka(rs2.getDouble("omloop")),
