...
public final class DlgKtgPenyakit extends javax.swing.JDialog {
    ...
    public DlgKtgPenyakit(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Kategori","Nama Kategori","Ciri-ciri Umum"};
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"kategori_penyakit","kd_ktg");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"kategori_penyakit","kd_ktg",TKd,"nm_kategori='"+TNm.getText()+"',ciri_umum='"+TCiri.getText()+"'");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReport("rptKtgPenyakit.jrxml","report","::[ Data Kategori Penyakit ]::","select * from kategori_penyakit order by kd_ktg");
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        prosesCari("select * from kategori_penyakit where kd_ktg like '%"+TCari.getText().trim()+"%' "+
                "or nm_kategori like '%"+TCari.getText().trim()+"%' "+
                "or ciri_umum like '%"+TCari.getText().trim()+"%' order by kd_ktg");
    ...
    */
    ...
    public void tampil() {
        String sql="select * from kategori_penyakit order by kd_ktg";
        prosesCari(sql);
    }
    ...
    private void getData() {
        int row=tbKtgPny.getSelectedRow();
        if(row!= -1){
            TKd.setText(tbKtgPny.getValueAt(row,0).toString());
            TNm.setText(tbKtgPny.getValueAt(row,1).toString());
            TCiri.setText(tbKtgPny.getValueAt(row,2).toString());
        }
    }
