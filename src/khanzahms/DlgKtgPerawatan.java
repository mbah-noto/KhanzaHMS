...
public final class DlgKtgPerawatan extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("kategori_perawatan","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode Kategori");
            tampil();
            emptTeks();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"kategori_perawatan","kd_kategori");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"kategori_perawatan","kd_kategori",TKd,"nm_kategori='"+TNm.getText()+"'");
    ...
    */
    ...
    private void getData() {
        ...
        if(row!= -1){
            TKd.setText(tbKategori.getValueAt(row,0).toString());
            TNm.setText(tbKategori.getValueAt(row,1).toString());
        }
    }
