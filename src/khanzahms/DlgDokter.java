...
public class DlgDokter extends javax.swing.JDialog {
    ...
    public DlgDokter(java.awt.Frame parent, boolean modal) {
        ...
        spesial.getTable().addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) { 
                KdSps.setText(spesial.getTextField().getText());   
                Sequel.cariIsi("select nm_sps from spesialis where kd_sps=?",TSpesialis,spesial.getTextField().getText());
            }
    ...
    private void initComponents() {
        ...
        cmbCrJk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "LAKI-LAKI", "PEREMPUAN", "SHOW ALL" }));
        ...
        CmbCrGd.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "A", "B", "AB", "O", "-", "SHOW ALL" }));
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2014-05-12" }));
        ...
        BtnSeek1.setBounds(836, 102, 28, 23);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"dokter","kd_dokter");
        tampil("");
        emptTeks();
    ...
    private void BtnAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllActionPerformed
        CmbCrStts.setSelectedItem("SHOW ALL");
        cmbCrJk.setSelectedItem("SHOW ALL");
        CmbCrGd.setSelectedItem("SHOW ALL");
        TCari.setText("");
        if((CmbCrGd.getSelectedItem().equals("SHOW ALL"))&&(CmbCrStts.getSelectedItem().equals("SHOW ALL"))&&(cmbCrJk.getSelectedItem().equals("SHOW ALL"))){
            tampil("");
        }
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        String sql=" dokter.kd_sps=spesialis.kd_sps ";
        prosesCari("select kd_dokter,nm_dokter,jk,tmp_lahir, "+
                "tgl_lahir,gol_drh,agama,almt_tgl,no_telp, "+
                "stts_nikah,nm_sps,alumni,no_ijn_praktek "+
                "from dokter,spesialis "+
                "where "+
    ...
    private void cmbCrJkItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbCrJkItemStateChanged
        ...
        if((cmbCrJk.getItemCount()>0)&&(CmbCrGd.getItemCount()>0)&&(CmbCrStts.getItemCount()>0)){
            if(cmbCrJk.getSelectedItem().toString().equals("SHOW ALL")&&CmbCrGd.getSelectedItem().toString().equals("SHOW ALL")&&CmbCrStts.getSelectedItem().toString().equals("SHOW ALL")){
                tampil("");
            }else if((! cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&CmbCrGd.getSelectedItem().toString().equals("SHOW ALL")&&CmbCrStts.getSelectedItem().toString().equals("SHOW ALL")){
                tampil("and jk='"+cmbCrJk.getSelectedItem().toString().substring(0,1)+"' ");
            }else if((! cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrGd.getSelectedItem().toString().equals("SHOW ALL"))&&CmbCrStts.getSelectedItem().toString().equals("SHOW ALL")){
                tampil("and jk='"+cmbCrJk.getSelectedItem().toString().substring(0,1)+"' "+
                        "and gol_drh='"+CmbCrGd.getSelectedItem()+"' ");
            }else if((! cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrGd.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrStts.getSelectedItem().toString().equals("SHOW ALL"))){
                ...
                tampil("and gol_drh='"+CmbCrGd.getSelectedItem()+"' "+
                        "and stts_nikah='"+CmbCrStts.getSelectedItem()+"' ");
            }else if((cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&(CmbCrGd.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrStts.getSelectedItem().toString().equals("SHOW ALL"))){
                tampil("and stts_nikah='"+CmbCrStts.getSelectedItem()+"' ");
            }else if((! cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&(CmbCrGd.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrStts.getSelectedItem().toString().equals("SHOW ALL"))){
                tampil("and jk='"+cmbCrJk.getSelectedItem().toString().substring(0,1)+"' "+
                        "and stts_nikah='"+CmbCrStts.getSelectedItem()+"' ");
            }else if((cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrGd.getSelectedItem().toString().equals("SHOW ALL"))&&(CmbCrStts.getSelectedItem().toString().equals("SHOW ALL"))){
  ...
  isForm();                
    ...
    */
    ...
    public void tampil(String kay) {
        String sql="select kd_dokter,nm_dokter,jk,tmp_lahir, "+
                   "tgl_lahir,gol_drh,agama,almt_tgl,no_telp, "+
                   "stts_nikah,nm_sps,alumni,no_ijn_praktek "+
                   "from dokter,spesialis "+
                   "where dokter.kd_sps=spesialis.kd_sps "+kay+
                   " order by kd_dokter";
        prosesCari(sql);
    }
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            if(tbDokter.getValueAt(row,2).toString().equals("L")){
                CmbJk.setSelectedItem("LAKI-LAKI");
            }else if(tbDokter.getValueAt(row,2).toString().equals("P")){
