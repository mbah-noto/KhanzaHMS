...
public class DlgKelurahan extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            Sequel.menyimpan("kelurahan","'0','"+Nama.getText()+"'","Kode kelurahan");
            tampil();
            emptTeks();
        }
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            ...
            Valid.pindah(evt,Nama,BtnBatal);
        }
    ...
    */
    ...
    public void tampil() {
        String sql="select nm_kel from kelurahan where nm_kel like '%"+TCari.getText().trim()+"%' ";
        prosesCari(sql);
    }
