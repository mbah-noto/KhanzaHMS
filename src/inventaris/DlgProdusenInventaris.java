...
private void TKdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TKdKeyPressed
        Valid.pindah(evt,BtnKeluar,TNm);
    ...
    */
    ...
    private void getData() {
        if(tbJnsPerawatan.getSelectedRow()!= -1){
            TKd.setText(tabMode.getValueAt(tbJnsPerawatan.getSelectedRow(),0).toString());
            TNm.setText(tabMode.getValueAt(tbJnsPerawatan.getSelectedRow(),1).toString());
            TAlamat.setText(tabMode.getValueAt(tbJnsPerawatan.getSelectedRow(),2).toString());
            TTlp.setText(tabMode.getValueAt(tbJnsPerawatan.getSelectedRow(),3).toString());
            TEmail.setText(tabMode.getValueAt(tbJnsPerawatan.getSelectedRow(),4).toString());
            TWeb.setText(tabMode.getValueAt(tbJnsPerawatan.getSelectedRow(),5).toString());
        }
    }
