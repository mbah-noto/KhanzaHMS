...
public class DlgSirkulasi extends javax.swing.JDialog {
    ...
    public DlgSirkulasi(java.awt.Frame parent, boolean modal) {
        ...
        inventaris.getTable().addMouseListener(new MouseListener() {
            @Override
    ...
    private void initComponents() {
        ...
        jLabel19.setBounds(-10, 170, 850, 14);
        ...
        BtnPglIn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnPglIn.setMnemonic('1');
        BtnPglIn.setToolTipText("Alt+1");
        BtnPglIn.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        BtnPglIn.setName("BtnPglIn"); // NOI18N
        BtnPglIn.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnPglIn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPglInActionPerformed(evt);
            }
        });
        internalFrame2.add(BtnPglIn);
        BtnPglIn.setBounds(690, 25, 25, 23);
        ...
        BtnPglPt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnPglPt.setMnemonic('3');
        BtnPglPt.setToolTipText("Alt+3");
        BtnPglPt.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        BtnPglPt.setName("BtnPglPt"); // NOI18N
        BtnPglPt.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnPglPt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPglPtActionPerformed(evt);
            }
        });
        internalFrame2.add(BtnPglPt);
        BtnPglPt.setBounds(690, 145, 25, 23);
        ...
        tgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2014-05-03" }));
        ...
        panelCari.add(BtnSeek2);

        jLabel27.setText("Tgl.Pnjm :");
        jLabel27.setName("jLabel27"); // NOI18N
        jLabel27.setPreferredSize(new java.awt.Dimension(80, 23));
        panelCari.add(jLabel27);

        TglPinjam1.setEditable(false);
        TglPinjam1.setForeground(new java.awt.Color(50, 70, 50));
        TglPinjam1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2014-05-03" }));
        TglPinjam1.setDisplayFormat("yyyy-MM-dd");
        ...
        TglPinjam2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2014-05-03" }));
        TglPinjam2.setDisplayFormat("yyyy-MM-dd");
    ...
    private void BtnOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnOutActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            BtnPglIn.setEnabled(false);
            BtnPglPt.setEnabled(true);
            WindowInput.setAlwaysOnTop(false);
            WindowInput.setVisible(true);
        }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            BtnBatal.requestFocus();
                ...
                String tglcari=" inventaris_peminjaman.tgl_pinjam between '"+TglPinjam1.getSelectedItem()+"' and '"+TglPinjam2.getSelectedItem()+"' and ";
           ...
           if(no_inventaris.isEditable()==true){
                if(! status.getText().trim().equals("Ada")){
                    ...
                    Sequel.menyimpan("inventaris_peminjaman","'"+peminjam.getText()+"','"+tlp.getText()+"','"+
                        ...
                        tgl.getSelectedItem()+"','0000-00-00','"+
                ...
                //mengedit-------------------------------------------------
                Sequel.queryu("update inventaris_peminjaman set tgl_kembali='"+tgl.getSelectedItem()+"',nip='"+nip.getText()+"',status_pinjam='Sudah Kembali' where peminjam='"+peminjam.getText()+"' and no_inventaris='"+no_inventaris.getText()+"' and tgl_pinjam='"+TIn.getText()+"'");
...
private void BtnPglInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPglInActionPerformed
    pilihan=1;
    var.setStatus(true);
    inventaris.emptTeks();
    inventaris.tampil();
    ...
    inventaris.setAlwaysOnTop(false);
    inventaris.setVisible(true);        
}//GEN-LAST:event_BtnPglInActionPerformed
...
private void BtnPglPtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPglPtActionPerformed
    var.setStatus(true);
    petugas.emptTeks();
    petugas.tampil();
...
}//GEN-LAST:event_BtnPglPtActionPerformed
...
private void tlpKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tlpKeyPressed
    ...
    */
    ...
    private widget.Button BtnPglIn;
    private widget.Button BtnPglPt;
